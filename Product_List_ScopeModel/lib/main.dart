      ...
      body: Center(
        child: Container(
          ...
          child: Column(
              ...
              children: <Widget>[
                Image.asset("images/" + this.item.image,height: 100.0,width: MediaQuery.of(context).size.width,),
                Expanded(
                    child: Container(
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: IconButton(
            icon: (
                //Nếu nhấn sao thứ 2 thì sao thứ 1 cũng đỏ
                _rating >= 2 ?
                Icon(
                  Icons.star,
                  size: _size,
        ...
        Container(
          ...
          child: IconButton(
            icon: (
                //Nếu nhấn sao thứ 3 thì 2 sao trước cũng đỏ
                _rating >= 3 ?
                Icon(
                  Icons.star,
                  size: _size,
